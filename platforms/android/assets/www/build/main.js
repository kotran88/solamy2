...
var TermPage = /** @class */ (function () {
    ...
    TermPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-term',template:/*ion-inline-start:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\term\term.html"*/'\n\n<ion-header>\n\n  <div class="top_bar">\n\n      <span class="title">{{type}}</span>\n\n      <img style="width:32px;" src="assets/imgs/logout.png"  class="back_img" (click)="back()">\n\n  </div>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <div class="wrap mt30">{{content}}</div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\term\term.html"*/,
        }),
...
var MyquotStatusPage = /** @class */ (function () {
    function MyquotStatusPage(navCtrl, navParams, appmgr, common, http, modalCtrl) {
        ...
        this.http.postHttpData("/getAnalyseData", sendData, function (result) {
            ...
            if (result) {
                for (var i = 0; i < result.length; i++) {
                    _this.quotData.push({ "solar_power": result[i].solar_power, "reg_time": result[i].reg_time, "id": result[i].id, "month_fee": result[i].month_fee, "contract_time": result[i].contract_time, "address": _this.uintToString(result[i].address.data).split(" ")[0] + _this.uintToString(result[i].address.data).split(" ")[1] });
                }
            }
            else {
                _this.quotData = null;
        ...
        this.http.postHttpData("/getSubmitContract", sendData1, function (result) {
            if (result) {
                ...
                console.log("rrrr" + _this.submitCont);
            }
            else {
                ...
                _this.http.postHttpData("/getCompanyDataByCompId", sendData2, function (result) {
                    if (result) {
                        ...
                        if (result.add_price_content != null) {
                            ...
                            _this.contData = { "contract_time": contract_time, "ins_exp_time": ins_exp_time, "ins_comp_time": ins_comp_time, "ins_hope_time": ins_hope_time, "final_price": result.final_price, "add_price": result.add_price, "add_price_content": _this.uintToString(result.add_price_content.data), "add_price_flag": result.add_price_flag, "comp_id": result.comp_id, "company_name": _this.uintToString(result.company_name.data), "cont_price": result.cont_price };
                        }
                        else {
                            var contract_time = "";
                            if (result.contract_time != null) {
                            ...
                            _this.contData = { "contract_time": contract_time, "ins_exp_time": ins_exp_time, "ins_comp_time": ins_comp_time, "ins_hope_time": ins_hope_time, "final_price": result.final_price, "add_price_flag": result.add_price_flag, "comp_id": result.comp_id, "company_name": _this.uintToString(result.company_name.data), "cont_price": result.cont_price };
                        }
                ...
                for (var i = 0; i < result.length; i++) {
                    if (result[i].code == "1") {
                        ...
                        if (_this.modulecount == 1) {
                            ...
                            _this.moduleName = _this.uintToString(result[i].product_name.data);
                    ...
                    if (result[i].code == 2) {
                        _this.invNamecount++;
                        if (_this.invNamecount == 1) {
                            _this.invPhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
                            _this.invName = _this.uintToString(result[i].product_name.data);
                        }
                    }
                    if (result[i].code == 3) {
                        _this.qualitycount++;
                        if (_this.qualitycount == 1) {
                            _this.qPhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
                            _this.qName = _this.uintToString(result[i].product_name.data);
                        }
                    }
                    if (result[i].code == 4) {
                        _this.modGcount++;
                        if (_this.modGcount == 1) {
                            _this.modPhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
                            _this.modName = _this.uintToString(result[i].product_name.data);
                        }
                    }
                    if (result[i].code == 5) {
                        _this.invGcount++;
                        if (_this.invGcount == 1) {
                            _this.invGPhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
                            _this.invGName = _this.uintToString(result[i].product_name.data);
                        }
                    }
                    if (result[i].code = 6) {
                        _this.etcCount++;
                        if (_this.etcCount == 1) {
                            _this.etcPhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
...
var BenefitgeneratorPage = /** @class */ (function () {
    ...
    BenefitgeneratorPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-benefitgenerator',template:/*ion-inline-start:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\benefitgenerator\benefitgenerator.html"*/'<ion-header>\n\n    <div class="top_bar">\n\n        <span class="title">상담요청</span>\n\n        <img src="assets/imgs/logout.png" style="width:32px" class="back_img" (click)="back()">\n\n    </div>\n\n  </ion-header>\n\n  \n\n  \n\n  <ion-content padding>\n\n    <div class="banner">\n\n    </div>\n\n    \n\n    \n\n    <div style="" class="wrap cont_2">\n\n      \n\n      <h3   style="color: #e15a00; \n\n      padding-left: 10px;" class="mt10">수익형 발전소(RPS)</h3><br>\n\n      \n\n      <p class="mt1">수익형 정부지원사업 설명 태양광태양광 정부지원사업 설명 태양광</p>\n\n      <p class="mt1">수익형 정부지원사업 설명 태양광태양광 정부지원사업 설명 태양광</p>\n\n      <p class="mt1">수익형 정부지원사업 설명 태양광태양광 정부지원사업 설명 태양광</p>\n\n      <p class="mt1">수익형 정부지원사업 설명 태양광태양광 정부지원사업 설명 태양광</p>\n\n      <p class="mt1">수익형 정부지원사업 설명 태양광태양광 정부지원사업 설명 태양광</p>\n\n     \n\n    </div>\n\n    <div class="form mt30">\n\n        <div class="alert-md">\n\n          <label>이메일</label>\n\n          <input type="text" class="alert-input" [(ngModel)]="email"/>\n\n        </div>\n\n        <div class="alert-md">\n\n          <label>성함</label>\n\n          <input type="text" class="alert-input" maxlength="10" [(ngModel)]="name"/>\n\n        </div>\n\n        <div class="alert-md">\n\n            <label>연락처</label>\n\n            <input type="text" class="alert-input" maxlength="15" [(ngModel)]="tel"/>\n\n          </div>\n\n      </div>\n\n    <button style="   \n\n    background: #e15a00;\n\n    color: white;\n\n    width: 75%;\n\n    border-radius: 10px;\n\n    margin: auto;\n\n    top: 20px;\n\n    display: -webkit-box;"\n\n     ion-button color="light"  (click)="consulting()">상담 요청하기</button>\n\n\n\n  </ion-content>\n\n'/*ion-inline-end:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\benefitgenerator\benefitgenerator.html"*/,
        }),
...
var ResetPasswordPage = /** @class */ (function () {
    ...
    ResetPasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-reset-password',template:/*ion-inline-start:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\reset-password\reset-password.html"*/'\n\n<ion-header>\n\n  <div class="top_bar">\n\n      <span class="title">비밀번호 변경</span>\n\n      <img src="assets/imgs/back.png" class="back_img" (click)="back()">\n\n  </div>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n  <div class="form">\n\n    <ion-list>\n\n      <ion-item>\n\n        <ion-label floating>비밀번호</ion-label>\n\n        <ion-input [(ngModel)]="password" type="password"></ion-input>\n\n      </ion-item>\n\n      <ion-item class="mt10">\n\n        <ion-label floating>비밀번호 재입력</ion-label>\n\n        <ion-input [(ngModel)]="repassword" type="password"></ion-input>\n\n      </ion-item>\n\n      <span></span>\n\n    </ion-list>\n\n\n\n    <div class="item btn-cont mt50">\n\n      <a (click)="reset()" class="boxBtn save">저장</a>\n\n    </div>\n\n  </div>\n\n  \n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\reset-password\reset-password.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_3__providers_appmgr_appmgr__["a" /* AppmgrProvider */],
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    if (result[i].code == "1") {
                        ...
                        if (_this.modulecount == 1) {
                            console.log(result[i]);
                            _this.modulePhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
                            _this.module_name = _this.uintToString(result[i].product_name.data);
                            console.log(_this.modulePhoto);
                            //http://solarmy.co.kr/solarmy_admin/uploads/20190327/155366537011.png
                    ...
                    if (result[i].code == 2) {
                        ...
                        if (_this.invNamecount == 1) {
                            _this.invPhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
                            _this.inv_name = _this.uintToString(result[i].product_name.data);
                        }
                    }
                    if (result[i].code == 3) {
                        _this.qualitycount++;
                        if (_this.qualitycount == 1) {
                            _this.qPhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
                            _this.quality = _this.uintToString(result[i].product_name.data);
                        }
                    }
                    if (result[i].code == 4) {
                        _this.modGcount++;
                        if (_this.modGcount == 1) {
                            _this.modPhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
                            _this.module_guarent = _this.uintToString(result[i].product_name.data);
                        }
                    }
                    if (result[i].code == 5) {
                        _this.invGcount++;
                        if (_this.invGcount == 1) {
                            _this.invGPhoto = "http://solarmy.co.kr" + _this.uintToString(result[i].file_path.data) + "" + _this.uintToString(result[i].file_name.data);
                            _this.inv_guarent = _this.uintToString(result[i].product_name.data);
                        }
                    }
                    if (result[i].code = 6) {
                        _this.etcCount++;
                    ...
                    console.log(_this.invGPhoto);
                    console.log(_this.invGName);
                    // if(result[i].code==6){
...
var FirstPage = /** @class */ (function () {
    ...
    FirstPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-first',template:/*ion-inline-start:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\first\first.html"*/''/*ion-inline-end:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\first\first.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_3__providers_appmgr_appmgr__["a" /* AppmgrProvider */],
...
var LoadingPage = /** @class */ (function () {
    ...
    LoadingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-loading',template:/*ion-inline-start:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\loading\loading.html"*/'<div class="content">\n\n    <div class="loading">\n\n        <img src="assets/imgs/loading.gif"/>\n\n        <p>{{ load_txt }}</p>\n\n    </div>\n\n</div>  '/*ion-inline-end:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\loading\loading.html"*/,
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\user\OneDrive\solamy 2\solamy2\src\app\app.html"*/'<ion-nav #rootNav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"C:\Users\user\OneDrive\solamy 2\solamy2\src\app\app.html"*/
        }),
...
var PdfViewerPage = /** @class */ (function () {
    ...
    PdfViewerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-pdf-viewer',template:/*ion-inline-start:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\pdf-viewer\pdf-viewer.html"*/'\n\n<ion-header>\n\n  <div class="top_bar">\n\n    <span class="title">계약서</span>\n\n    <img src="assets/imgs/close.png" class="back_img" (click)="onClose()">\n\n  </div>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n  <!-- <pdf-viewer [src]="url" \n\n              [show-all]="true"\n\n              [original-size]="false"\n\n              [zoom]="1.0" \n\n              style="display: block"\n\n  ></pdf-viewer> -->\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\user\OneDrive\solamy 2\solamy2\src\pages\pdf-viewer\pdf-viewer.html"*/,
        }),
